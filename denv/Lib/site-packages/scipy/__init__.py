...
def _delvewheel_init_patch_1_1_0():
    ...
    if (
        ...
        and not os.path.exists(os.path.join(sys.base_prefix, "conda-meta"))
        ...
        with open(os.path.join(libs_dir, ".load-order-scipy-1.9.3")) as file:
...
if sys.version_info >= (3, 12):
    _msg = (
        "Your Python version is too new. SciPy 1.9 supports "
