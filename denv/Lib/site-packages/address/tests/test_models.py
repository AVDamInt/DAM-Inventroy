...
class CountryTestCase(TestCase):
    ...
    def test_unique_name(self):
        self.assertRaises(
            IntegrityError, Country.objects.create, name="Australia", code="**"
        )

    def test_unicode(self):
        self.assertEqual(unicode(self.au), "Australia")
...
class StateTestCase(TestCase):
    ...
    def test_unique_name_country(self):
        ...
        self.assertRaises(
            IntegrityError, State.objects.create, name="Tasmania", country=self.au
        )

    def test_unicode(self):
        self.assertEqual(unicode(self.vic), "Victoria, Australia")
        self.assertEqual(unicode(self.empty), "Australia")
...
class LocalityTestCase(TestCase):
    ...
    def test_unicode(self):
        self.assertEqual(
            unicode(self.au_vic_mel), "Melbourne, Victoria 3000, Australia"
        )
        self.assertEqual(unicode(self.au_vic_ftz), "Fitzroy, Victoria, Australia")
        self.assertEqual(unicode(self.au_vic_empty), "Victoria, Australia")
...
class AddressTestCase(TestCase):
    def setUp(self):
        ...
        self.ad_empty = Address.objects.create(
            locality=self.au_vic_nco, raw="Northcote, Victoria"
        )
    ...
    def test_unicode(self):
        self.assertEqual(
            unicode(self.ad1), "1 Some Street, Melbourne, Victoria 3000, Australia"
        )
        self.assertEqual(unicode(self.ad_empty), "Northcote, Victoria 3070, Australia")
...
class AddressFieldTestCase(TestCase):
    ...
    def test_assignment_from_dict(self):
        ...
        self.assertEqual(
            self.test.address.locality.postal_code, self.ad1_dict["postal_code"]
        )
        self.assertEqual(self.test.address.locality.state.name, self.ad1_dict["state"])
        self.assertEqual(
            self.test.address.locality.state.code, self.ad1_dict["state_code"]
        )
        self.assertEqual(
            self.test.address.locality.state.country.name, self.ad1_dict["country"]
        )
        self.assertEqual(
            self.test.address.locality.state.country.code, self.ad1_dict["country_code"]
        )
